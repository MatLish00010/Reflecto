...
import { Alert, AlertDescription } from '@/shared/client/ui/alert';
        ...
        {alert.message && (
          ...
          >
            ...
            <Button
              ...
              size="sm"
              onClick={handleClose}
              className="absolute top-1/2 -translate-y-1/2 right-2 h-6 w-6 p-0 hover:bg-background/80 transition-colors"
            >
